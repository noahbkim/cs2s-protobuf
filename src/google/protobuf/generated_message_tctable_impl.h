...
#define PROTOBUF_TC_PARSE_FUNCTION_LIST                                   \
  ...
  PROTOBUF_TC_PARSE_FUNCTION_LIST_SINGLE(FastMSV)                         \
  PROTOBUF_TC_PARSE_FUNCTION_LIST_SINGLE(FastMl)                          \
  PROTOBUF_TC_PARSE_FUNCTION_LIST_END_GROUP()                             \
  PROTOBUF_TC_PARSE_FUNCTION_X(MessageSetWireFormatParseLoopLiteNoVerify) \
  PROTOBUF_TC_PARSE_FUNCTION_X(MessageSetWireFormatParseLoop)             \
  PROTOBUF_TC_PARSE_FUNCTION_X(MessageSetWireFormatParseLoopNoVerify)
...
class PROTOBUF_EXPORT TcParser final {
 public:
  ...
  static const char* MessageSetWireFormatParseLoopLiteNoVerify(
      PROTOBUF_TC_PARAM_NO_DATA_DECL);
  static const char* MessageSetWireFormatParseLoop(
      PROTOBUF_TC_PARAM_NO_DATA_DECL);
  static const char* MessageSetWireFormatParseLoopNoVerify(
      PROTOBUF_TC_PARAM_NO_DATA_DECL);
  ...
  PROTOBUF_NOINLINE static const char* FastMSVS1(PROTOBUF_TC_PARAM_DECL);
  PROTOBUF_NOINLINE static const char* FastMSVS2(PROTOBUF_TC_PARAM_DECL);
  ...
  static const char* DummyVerifyFunc(const char*, ParseContext*);
 ...
 private:
  ...
  template <class MessageBaseT, bool Verify>
